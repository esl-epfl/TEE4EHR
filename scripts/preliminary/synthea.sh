...
DATA_NAME="synthea_100" # we only use synthea with 100 most frequent events
...
HPs="-w_pos -pos_alpha 1 -batch_size 64  -lr 0.003 -lr_scheduler StepLR -weight_decay 1 --te_d_mark 32 --te_d_time 16 --te_d_inner 128 --te_d_k 32 --te_d_v 32 "
...
do
    ...
    for i_split in {0..4} # split index
    do
